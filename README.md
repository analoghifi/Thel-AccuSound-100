...
* replacing almost all foil caps with the very good CDE film/foil KP-caps (<a href="/audio and filter capacitors/docs/datasheets/kp/CDE_series_WPP.pdf">WPP-Series</a>)
